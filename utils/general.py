...
def strip_optimizer(f='weights/v1.pt', s=''):  # from utils.general import *; strip_optimizer()
...
def plot_one_box_with_dot(x, img, center_coordinates, color=None, label=None, line_thickness=None):
    ...
    if label:
        ...
        cv2.circle(img, center_coordinates, 3, color, 3) # plot a dot
